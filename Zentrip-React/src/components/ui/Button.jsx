const VARIANTS = {
  ...
  danger:    'w-full bg-feedback-error-solid hover:opacity-90 text-white py-2 rounded-full font-semibold transition duration-200 shadow-md hover:shadow-lg active:scale-[0.98] cursor-pointer',
};
