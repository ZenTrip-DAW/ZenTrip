const VARIANTS = {
  ...
  orange:    'w-full bg-primario-3 hover:bg-orange-400 text-white py-2 rounded-full font-semibold transition duration-200 shadow-md hover:shadow-lg active:scale-[0.98] cursor-pointer',
