  ...
  return (
    <section className="px-16 py-24 bg-slate-50">
      ...
      <div className="flex relative">
        {/* connector line */}
        <div className="absolute top-8 left-24 right-24 h-0.5 bg-gradient-to-r from-orange-300 to-blue-200 opacity-40" />

        {STEPS.map((s, i) => (
          <div key={i} className="flex-1 flex flex-col items-center text-center px-6 relative group">
